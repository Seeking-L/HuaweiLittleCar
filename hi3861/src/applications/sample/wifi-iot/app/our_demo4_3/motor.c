...
extern expect_speed_state[];
extern current_speed_state[];
...
void car_left(void)
{
    ...
    car_stop();
    pwm_left();
    if (current_speed_state[0] == 1 &&
        current_speed_state[1] == 1)
    {
        current_speed_state[0] = 0;
        current_speed_state[1] = 0;
    }
    else if (current_speed_state[0] == 1 &&
             current_speed_state[1] == 0)
    {
        current_speed_state[0] = 0;
        current_speed_state[1] = 1;
    }
    else if (current_speed_state[0] == 0 &&
             current_speed_state[1] == 1)
    {
        current_speed_state[0] = 1;
        current_speed_state[1] = 1;
    }
    else if (current_speed_state[0] == 0 &&
             current_speed_state[1] == 0)
